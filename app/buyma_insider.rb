...
require_rel './buyma_insider/indexer/getoutside'
require_rel './buyma_insider/indexer/shoeme'

require_rel './buyma_insider/merchant/base'
require_rel './buyma_insider/merchant/ssense'
require_rel './buyma_insider/merchant/zara'
require_rel './buyma_insider/merchant/getoutside'
require_rel './buyma_insider/merchant/shoeme'
